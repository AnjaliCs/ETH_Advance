...
contract LPTokenWrapper {
    ...
    IERC20 public MVP_Pool = IERC20(0x1d28c900dbc826D9733C1a3270F6b2D856862233); //LYC
...
contract MVPPool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public mvp = IERC20(0x3786A859A10b84099B577a7822EbcEAD284aE3Fb); //DYC
    uint256 public constant DURATION = 6048000;      // <!-- 10 WEEKS -->

    uint256 public starttime = 1643608696;       // <!-- Jan-31-2022 -->
